...
public class SwipeHelper implements Gefingerpoken {
    ...
    public SwipeHelper(int swipeDirection, Callback callback, float densityScale,
            float pagingTouchSlop,float touchSlop) {
        mCallback = callback;
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                ...
                Log.e(TAG,"onTouchEvent ACTION_DOWN mCurrView:" + mCurrView);
            ...
            case MotionEvent.ACTION_MOVE:
                if (!mDragging && mCurrView != null && !mLongPressSent && !mOtherDragging) {
                    mVelocityTracker.addMovement(ev);
                    float pos = getPos(ev);
                    ...
                    Log.e(TAG,"onInterceptTouchEvent ACTION_DOWN mDragging:" + mDragging + " mOtherDragging:" + mOtherDragging);
    ...
    public boolean isOtherDragging(){
    	return mOtherDragging;
    }
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                if (mCurrView != null) {
                    ...
                    // maxScrollDistance
                    //
                    boolean wrongDirection = delta > 0f;//向右或者下方滑动
                    if (CONSTRAIN_SWIPE && (!mCallback.canChildBeDismissed(mCurrView) || wrongDirection)) {
                    ...
                    Log.e(TAG,"onTouchEvent setTranslation mCurrAnimView:" + mCurrAnimView + " delta:" + delta);                    
