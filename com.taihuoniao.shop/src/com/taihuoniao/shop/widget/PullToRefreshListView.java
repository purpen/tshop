...
public class PullToRefreshListView extends ListView implements OnScrollListener {  
    ...
    public void onScroll(AbsListView view, int firstVisiableItem, int visibleItemCount,  int totalItemCount) {  
        ...
        if (refreshListener != null) {  
            refreshListener.onScroll(firstItemIndex,visibleItemCount,totalItemCount);  
        }        
    }  
	...
	protected void onOverScrolled(int scrollX, int scrollY, boolean clampedX,
        ...
        if (refreshListener != null) {  
        	if(firstItemIndex == 0 && isRecored && currentY > startY)
        		refreshListener.onRefreshHead();
        	else 
        		refreshListener.onRefreshTail();  
        }
	}  
